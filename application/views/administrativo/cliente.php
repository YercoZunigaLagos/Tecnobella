<html>
    ...
    <body>
            ...
            <div class="row">
                <div class="col l5 m12 s12" style="margin-top: 5%">
                    <div class="card-panel z-depth-3">
                         <h4 class="black-text" style="font-weight: 900">Agregar Cliente</h4>
                        <div class="row">
                                ...
                                <div class="col l12 s12 m6">
                                    ...
                                    <div class="input-field col s12 l6">
                                        ...
                                        <input id="nombre_servicio" name="nombre_cliente" type="text" data-length="40" v-model="nombre_cliente">
                                        <label for="nombre_cliente">Nombre de cliente</label>
                                    </div>
                                    
                                    <div class="input-field col s12 l6">
                                        <i class="material-icons prefix">comment</i>
                                        <input id="nombre_servicio" name="numero_telefonico" type="text" data-length="40" v-model="numero_telefonico">
                                        <label for="numero_telefonico">Numero telefonico</label>
                                    </div>
                                    <div class="input-field col s12 l6">
                                        <i class="material-icons prefix">comment</i>
                                        <input id="nombre_servicio" name="apellido_cliente" type="text" data-length="40" v-model="apellido_cliente">
                                        <label for="apellido_cliente">Apellido de cliente</label>
                                    </div>
                                    <div class="input-field col s12 l6">
                                        <i class="material-icons prefix">comment</i>
                                        <input id="nombre_servicio" name="apellido_cliente" type="text" data-length="40" v-model="apellido_cliente">
        ...
        <script src="<?= base_url() ?>assets/js/cliente.js" type="text/javascript"></script>
